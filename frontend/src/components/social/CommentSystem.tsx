        ...
        <div className="mb-3">
          {editingComment && editingComment.id === comment.id ? (
            ...
            <div className="bg-blue-50 rounded-lg p-3 border border-blue-200">
              <div className="flex items-center justify-between mb-2">
                <span className="text-sm text-blue-700 font-medium">댓글 수정</span>
              </div>
              <textarea
              ...
              <div className="flex justify-end mt-3 space-x-2">
                ...
                <button
                  ...
                  className="flex items-center space-x-1 bg-blue-600 text-white px-3 py-1.5 rounded-md hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors text-sm"
                >
...
export default function CommentSystem({ worldcupId, initialCommentCount: _initialCommentCount = 0, onCommentCountChange, onShowRanking }: CommentSystemProps) {
  ...
  return (
    <div className="bg-gray-50 rounded-lg p-6">
      ...
      {/* Old edit form removed - now using inline editing */}
